var Autocomplete = {
  ...
  draw: function() { // renders the data in the listUI element.
    var child;
  ...
  reset: function() {
    ...
    this.draw();
                                    ...
                                    // Ask: Is there a reason to add these elements
                                    // (wrapper div, ui list, and overlay)
                                    // via javascript? Why not just put them in the erb?
                                    // Is this just to show us how?
  wrapInput: function() {
